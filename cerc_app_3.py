...
class CSR_PDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 10, "CONFIDENTIAL - Clinical Study Report (CSR) - CERC AI", 0, 1, "R")
...
st.set_page_config(page_title="CERC AI Assistant", layout="wide", page_icon="🏥")
st.title("🏥 CERC - Expert CSR PDF Generator")
...
if st.button("🚀 Générer le Rapport PDF Complet", use_container_width=True):
    ...
    pdf.cell(0, 10, "Generated by CERC AI Expert System", 0, 1, "C")
    pdf.ln(10)
